...
export async function get_livedata_of_posts_by_tagname(tag_name) {
...
export async function init_catagorized_posts_livedata(catagory, posts, hours=2) {
    
    const cachedResponse = cache.get(catagory);
