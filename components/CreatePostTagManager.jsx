  ...
  return (
    <React.Fragment>
        <div style={{display: 'flex', alignItems: 'center', width: '100%', gap: '1.5rem'}}>
            <StyledInput value={tagValue} onChange={(e) => {setTagValue(e.target.value)}} onKeyDown={(e) => {e.key === 'Enter' && (addTag(SlugifyTagName(tagValue)) || setTagValue(''))}} placeholder='Smash up Tags...' maxLength={20} />
