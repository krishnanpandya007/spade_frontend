    ...
    return (
        ...
        >
            ...
            <Box style={{
                ...
                <DialogContent style={{fontWeight: '400', fontFamily: 'Poppins', color :theme.palette.text.default}}><b>This action is not reversable!</b> You can&apos;t Link this post again to your profile! &nbsp;<br/><a style={{color: '#5800FF', textDecoration: 'underline', fontSize: '0.8rem'}} href="https://docs.spadebeta.in">Learn More.</a></DialogContent>
